...
func TestPermissionMatrixScopesOneActionToOneProject(t *testing.T) {
	...
	_ = tx.AddAssignmentExtended(ctx, "p1/Shared", "g-1", 0, 0, 1, 0, 1, 0)
	_ = tx.AddAssignmentExtended(ctx, "p1/Shared/12", "u-1", 2, 0, 0, 0, 2, 0)
	_ = tx.AddAssignmentExtended(ctx, "p1/Shared/12", "g-1", 0, 0, 0, 1, 0, 1)
	_ = tx.AddAssignmentExtended(ctx, "p2", "u-1", 1, 0, 0, 0, 1, 0)
	_ = tx.Commit()
